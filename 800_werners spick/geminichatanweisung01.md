# Gemini-Gespräch 1/4 — Globales Datenmodell

> Gesprächsnotiz zur gemeinsamen Ideenentwicklung. Sie gehört zu den Dateien `geminichatanweisung01.md` bis `geminichatanweisung04.md`. Verbindlich für ATELIER ist [`DATENMODELL.md`](../DATENMODELL.md).
...
1. **Diese Datei:** gemeinsames Datenmodell
