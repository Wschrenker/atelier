...
Ein **echter Glockenrock (Tellerrock)** unter einem **asymmetrischen,
drapierten Wickeloberteil**.

Ein absolut ruhiger, geometrischer Rock unter einem sehr bewegten Oberteil.
Beides trägt sich gegenseitig.

## Die zwei Quellen

| Teil | Buchseite | Bezeichnung im Buch |
|---|---|---|
...
Fotos: `100_quellen/10_hofenbitzer_b1/10_Bilder/43-130/20260617_160345.jpg` (S. 44) ·
`100_quellen/10_hofenbitzer_b1/10_Bilder/368-544/20260619_144937.jpg` (S. 423)
...
## ⚠️ Fachnähte und Spezialverarbeitungen — Werner prüft am Buch

Was dieses Kleid über die Grundschnitte hinaus braucht:
...
| 6 | Asymmetrischer Ausschnitt mit Beleg | S. 423 ❑8b + Belege-Kapitel |
| 7 | Armloch-Verarbeitung, ärmellos | ? |
| 8 | Schmaler Saum / Rollsaum am Kreisrock | ? |
| 9 | Aushängen vor dem Saumen (Schrägfadenlauf zieht sich) | ? — evtl. gar nicht im Buch |
| 10 | Futter / Unterkleid | ? |

Bei 7 bis 10 weiß ich nicht, ob und wo das Buch sie behandelt.
**Punkt 9 ist der unsicherste** — es ist Fertigungswissen, kein Konstruktionswissen,
und könnte fehlen.

Sobald Werner die Buchstellen benennt, wandern sie in die Roadmap.

---

## Was bewusst draußen bleibt

Hosen · Jacken · Sportswear · Taschen · Kragen · Ärmel und Ärmelvarianten ·
Prinzessnaht · Korsage · Schleppe · Empire · Meerjungfrau.

Nicht verworfen — vertagt. Jedes davon ist später ein Modul mehr,
kein Neubau.
