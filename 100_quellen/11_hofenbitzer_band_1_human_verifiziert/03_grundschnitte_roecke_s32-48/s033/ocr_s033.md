...
1 \(\square 3\) P1 ist links oben am Blatt-rand.
Von P1 die Modellänge (MoL) als eine Senkrechte nach unten zeichnen \(\rightarrow\) vordere Mitte (vM).
...
Die Taillenlinie halbieren \(\rightarrow\) P7.
Die Saumlinie halbieren \(\rightarrow\) P8. P7 und P8 verbinden \(\rightarrow\) Seitenlinie.
P9 ist der Schnittpunkt von Seitenlinie und Hüftlinie.

□3 Grundgerüst zeichnen
